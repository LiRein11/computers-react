...
const ComputerRepair = () => {
  ...
  return (
    <>
      ...
      <main>
        <Breadcrumbs title={'Ремонт компьютера'} />
        <section class="internet">
          <div class="container">
            <h3 class="internet__title title">Ремонт компьютера</h3>
            <div class="internet__box">
              <div class="internet__box-content">
                <div class="internet-content">
                  <p class="internet-content__text-title">
                    Сборка и модернизация, замена комплектующих
                  </p>
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">
                        Установка материнской <br />
                        платы
                      </p>
                      <span class="internet-content__service-span">
                        При наличии материнской платы у клиента и без диагностики. <br />
                        Цена за 1 единицу.
                      </span>
                    </div>
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">Установка блока питания</p>
                      <span class="internet-content__service-span">
                        При наличии блока питания у клиента и без диагностики. <br />
                        Цена за 1 единицу.
                      </span>
                    </div>
                    <p class="internet-content__price-text">от 600</p>
                  </div>
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">Установка жёсткого диска</p>
                      <span class="internet-content__service-span">
                        При наличии жёсткого диска у клиента и без диагностики.
                        <br />
                        Цена за 1 единицу.
                      </span>
                    </div>
                    <p class="internet-content__price-text">от 300</p>
                  </div>
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">Установка оптического привода</p>
                      <span class="internet-content__service-span">
                        При наличии оптического диска у клиента и без диагностики.
                        <br />
                        Цена за 1 единицу.
                      </span>
                    </div>
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">Установка видеокарты</p>
                      <span class="internet-content__service-span">
                        При наличии видеокарты у клиента и без диагностики.
                        <br />
                        Цена за 1 единицу.
                      </span>
                    </div>
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">Установка звуковой карты</p>
                      <span class="internet-content__service-span">
                        При наличии звуковой карты у клиента и без диагностики.
                        <br />
                        Цена за 1 единицу.
                      </span>
                    </div>
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">Установка сетевой карты</p>
                      <span class="internet-content__service-span">
                        При наличии сетевой карты у клиента и без диагностики.
                        <br />
                        Цена за 1 единицу.
                      </span>
                    </div>
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">Установка вентилятора</p>
                      <span class="internet-content__service-span">
                        При наличии вентилятора у клиента и без диагностики.
                        <br />
                        Цена за 1 единицу.
                      </span>
                    </div>
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">Установка процессора</p>
                      <span class="internet-content__service-span">
                        При наличии процессора у клиента и без диагностики.
                        <br />
                        Цена за 1 единицу.
                      </span>
                    </div>
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">Установка оперативной памяти</p>
                      <span class="internet-content__service-span">
                        При наличии оперативной памяти у клиента и без диагностики.
                        <br />
                        Цена за 1 единицу.
                      </span>
                    </div>
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">
                        Настройка принтера, сканера подключение внешних устройств к компьютеру
                      </p>
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">Доставка комплектующих</p>
                      <span class="internet-content__service-span">
                ...
                <div class="internet-content">
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">Разборка компьютера</p>
                      <span class="internet-content__service-span">
                        Цена зависит от сложности работы.
                      </span>
                    </div>
                    <p class="internet-content__price-text">от 490</p>
                  </div>
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      ...
                      <span class="internet-content__service-span">
                        Защищает процессор от перегрева, выполняется обязательно.
                        <br />
                        Цена за 1 единицу.
                      </span>
                    </div>
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      ...
                      <span class="internet-content__service-span">
                        ...
                        аппаратных не исправностях выполняется обязательно.
                        <br />
                        Цена за 1 единицу.
                      </span>
                    </div>
                  ...
                  <div class="internet-content__item">
                    ...
                    <p class="internet-content__price-text">от 280</p>
                  </div>
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      <p class="internet-content__service-text">
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      ...
                      <span class="internet-content__service-span">
                        Если требуется. Цена зависит от сложности и производителя. <br />
                        Цена за 1 единицу.
                      </span>
                    </div>
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      ...
                      <span class="internet-content__service-span">
                        ...
                        выявления ее исходного размера. Цена за 1 единицу.
                      </span>
                    </div>
                  ...
                  <div class="internet-content__item">
                    <div class="internet-content__item-box internet-content__item-box--active">
                      ...
                      <span class="internet-content__service-span">
                        ...
                        из строя IDE/SATA контроллера. Цена за 1 единицу.
                      </span>
                    </div>
