...
const SystemInstallation = () => {
  ...
  <main>
    <Breadcrumbs title={'Установка системы'} />
    <section class="internet">
      <div class="container">
        <h3 class="internet__title title">
          Установка системы
        </h3>
          ...
          <div class="internet__box-content">
            <div class="internet-content">
              ...
              <div class="internet-content__item">
                <div class="internet-content__item-box">
                  <p class="internet-content__service-text">
                    Активация Windows 7 (seven)
                  </p>
                  <span class="internet-content__service-span">
                    В случае активации + 6 месяцев к гарантии
            ...
            <div class="internet-content">
              ...
              <div class="internet-content__item">
                <div class="internet-content__item-box">
                  <p class="internet-content__service-text">
                    Отчистка области автозапуска
                    программ и динамических
                    библиотек Windows (*.dll)
                  </p>
                  <span class="internet-content__service-span">
                    Цена за 1 единицу.
                  </span>
            ...
            <div class="internet-content">
              ...
              <div class="internet-content__item">
                <div class="internet-content__item-box">
                  ...
                  <span class="internet-content__service-span">
                    Выполняется обязательно при любых
                    работах. Цена за 1 единицу. Настройка
                    режима работы устройств и портов,
              ...
              <div class="internet-content__item">
                <div class="internet-content__item-box">
                  <p class="internet-content__service-text">
                    Создание разделов системы
                  </p>
                  <span class="internet-content__service-span">
                    Если разделов нет, создание минимум
                    одного обязательно.
                  </span>
                </div>
              ...
              <div class="internet-content__item">
                <div class="internet-content__item-box">
                  <p class="internet-content__service-text">
                    Изменение типа файловой
                    системы при переходе
                    c Windows 8 на Windows 7
                  </p>
                  <span class="internet-content__service-span">
              ...
              <div class="internet-content__item">
                <div class="internet-content__item-box">
                  ...
                  <span class="internet-content__service-span">
                    ...
                    С диска мастера цена от 690 Руб. <br/>
                    Цена за 1 единицу.
                  </span>
                </div>
              ...
              <div class="internet-content__item">
                <div class="internet-content__item-box">
                  ...
                  <span class="internet-content__service-span">
                    Цена за 1 единицу. Процедура является
                    неотъемлемой частью защиты от вирусов,
                    т. к. большинство вирусов проникает
                    именно через брауезер.
                  </span>
                </div>
              ...
              <div class="internet-content__item">
                <div class="internet-content__item-box">
                  <p class="internet-content__service-text">
                    ...
                    защиты от троянов, шпионских
                    программ, червей и защиты
                    электронной почты)
                  </p>
                  <span class="internet-content__service-span">
                    Цена за 1 единицу.
            ...
            <div class="internet-content">
              ...
              <div class="internet-content__item">
                <div class="internet-content__item-box">
                  <p class="internet-content__service-text internet-content__service-text--active">
                    В случае отказа от работ
                    оплачивается выезд мастера
                    (если тестирование не
                    проводилось)
                  </p>
                </div>
              ...
              <div class="internet-content__item">
                <div class="internet-content__item-box">
                  ...
                  <span class="internet-content__service-span">
                    Оплачивается в случае отказа клиента
                    от проведения работ нашим мастером
                    по устранению неисправности, либо при
                    невозможности проведения работ, либо
                    в случае, если ремонт компьютера или
                    ноутбука нецелесообразен. <br/>
                    Цена за 1 единицу.
                  </span>
                </div>
              ...
              <div class="internet-content__item">
                <div class="internet-content__item-box">
                  <p class="internet-content__service-text">
                    Ложный вызов мастера
                  </p>
                  <span class="internet-content__service-span">
                    Если клиент оформил заявку, а после
                    приезда мастера, клиент отказался
                    принять вызванного мастера, либо
                    мастер не смог приступить к работе
                    или тестированию по независящим
                    от мастера причинам, то вызов
                    является ложным и платным.
                  </span>
                </div>
                <p class="internet-content__price-text">1000</p>
              </div>
